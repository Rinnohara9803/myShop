...
class EditUserProductPage extends StatefulWidget {
  const EditUserProductPage({Key? key}) : super(key: key);

  static const routeName = '/edit_user_product_page';

  @override
  _EditUserProductPageState createState() => _EditUserProductPageState();
}
...
class _EditUserProductPageState extends State<EditUserProductPage> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      Product product = Provider.of<Products>(context).getById(routeArgs);
